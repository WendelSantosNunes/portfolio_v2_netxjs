  ...
  return (
    <div className="relative">
      <input
        ...
        {...props}
        id={inputId}
        className="bg-color-primary border-2 focus:border-color-tertiary w-full rounded-lg px-3 h-[52px] text-white placeholder-shown:pt-0 pt-4 peer  transition-all outline-none"
        placeholder=" "
      />
